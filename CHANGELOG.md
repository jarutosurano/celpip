...
### Added
- Speaking Task 8 Describing an Unusual Situation template with 4-blank system, Level 9 adjectives built-in, present perfect grammar built-in, 3 examples, and memorization checklist
- Speaking Task 7 Expressing Opinions template with 1-blank system, universal reasons, since/second/even-though grammar structures built-in, 3 examples, and memorization checklist
