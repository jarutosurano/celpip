---
title: "Task 1: Giving Advice Template"
description: "A memorizable universal template for CELPIP Speaking Task 1. Only fill in 3 blanks — everything else is pre-loaded and works for any prompt."
---

## The Template

**Prep time:** 30 seconds | **Speaking time:** 90 seconds | **Blanks to fill:** 3

Everything outside the brackets is **memorized word for word**. Only fill in `[NAME]`, `[SITUATION]`, and 2 advice items.
...
These work for **any prompt**. Just pick 2 from different rows.
