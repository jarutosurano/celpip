...
description: Core reading skills, answer engineering, and elimination techniques for CELPIP Reading
---
...
2. **Flag contrast markers** — *however, although, whereas, on the other hand, still*
...
5. **One-line gist** — Say it: "This is mostly about ___, arguing that ___ because ___"

!!! warning "Skim Pitfalls"
...
- Proper nouns: names, streets, programs, agencies
- Numbers & formats: 12:30 pm, $14.50, June 21, 3 lanes, Unit 5B
...
2. Hunt the anchor: scan vertically for the number/label/time
3. Read ±1 sentence around it
4. Verify every constraint — one mismatch = reject

!!! danger "High-Frequency Traps"
...
**Tone signals:**
- **Hedges** (soften): *may, might, tends to, appears to*
- **Boosters** (strengthen): *clearly, definitely, certainly*
- **Attitude verbs:** *appreciate, regret, recommend, oppose*
- **Register cues:** "Hi Alex… Thanks!" (informal) vs. "Dear Sir/Madam…" (formal)
...
**Three filters:**
1. **Text-only rule** — If you need outside knowledge, it's not safe
2. **One small step** — If you're stacking assumptions, stop
3. **Global sweep** — Check all paragraphs; confirm absence before choosing Not Stated
...
4. **Polarity & Logic** — *not, only, except, before/after/by/until* all correct?
5. **Speaker/Stance** — Right voice, right intensity?

### The ACE Quick Filter

On first read, tag each option:
- **A (Aligned)** — Matches text. Keep and verify.
- **C (Contradicts)** — Conflicts with the text. Eliminate.
- **E (Extra)** — Adds claims not in the text. Eliminate.
...
!!! tip "Speed Moves When Time Is Tight"
