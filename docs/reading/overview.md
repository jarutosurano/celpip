...
description: Understanding the CELPIP Reading test structure, environment, and question types
---
...
!!! warning "5-Second Decision Tree"
...
- [Reading Strategies](strategies.md) — Core skills, answer engineering, and elimination techniques
- [Practice Tips](practice-tips.md) — Pacing plans, vocabulary toolkit, and drill routines
- [Part 1: Correspondence](part-1-correspondence.md) — Mastering emails and reply drop-downs
- [Part 2: Diagram](part-2-diagram.md) — Timetables, maps, and constraint matching
- [Part 3: Information](part-3-information.md) — Paragraph mapping and Not Stated decisions
- [Part 4: Viewpoints](part-4-viewpoints.md) — Opinion tracking and inference
