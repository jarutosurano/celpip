      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Language Boosters', slug: 'resources/language-boosters' },
            { label: 'Transition Expressions', slug: 'resources/transition-expressions' },
            { label: 'Paraphrasing', slug: 'resources/paraphrasing' },
          ],
        },
      ],
