...
description: Mastering paragraph mapping, parallel terms, and Not Stated decisions in CELPIP Reading Part 3
---
...
3. **Mark contrast markers** — *however, although, in contrast, on the other hand* (these often host answers)
...
:::caution[Tiny Inferences Are Fine]
